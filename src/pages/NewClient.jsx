...
const NewClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Ocurrió un error al crear el cliente. Por favor, intente nuevamente.');
    } finally {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6">
        ...
        <h3 className="text-lg font-semibold mt-8 mb-4">Variables del Alma del Cliente</h3>
